...
@RestController
@RequestMapping("/api/video-processing-unit-kafka")
public class VideoProcessingUnitKafkaResource {

    private final Logger log = LoggerFactory.getLogger(VideoProcessingUnitKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public VideoProcessingUnitKafkaResource(KafkaProperties kafkaProperties) {
